...
**星语宇宙** 是一个原创中文天文科普网站，主题围绕天文知识、星空观测和宇宙探索展开。

这个项目的目标是把分散的宇宙知识整理成一个清晰、好读、可持续扩展的个人知识站：

- 用中文组织首页、文章、笔记、标签和导航。
- 用深空蓝紫、星云渐变和动态宇宙背景建立自己的视觉识别。
...
本项目是围绕“中文天文科普站”独立设计和持续完善的原创项目，使用 Astro 作为静态站点框架，并通过 GitHub Pages 发布。
